...
export default function Button({ variant = "primary", className = "", children, ...props }: ButtonProps) {
    const base =
        variant === "primary"
            ...
            : variant === "navy"
            ? "inline-flex items-center font-semibold uppercase border border-[#D28A44] justify-center text-white gap-3 bg-[#D28A44] font-medium p-[9px_19px_8px_19px] rounded-md hover:bg-white hover:border-white hover:text-[#D28A44] text-sm disabled:opacity-60"
            : variant === "white"
